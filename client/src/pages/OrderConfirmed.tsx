...
export default function OrderConfirmed() {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      window.location.href = `https://m.me/saikoramenandsushi?ref=${encodeURIComponent(order.orderNumber)}`;
    }, 1500);
  ...
  const messengerUrl = `https://m.me/saikoramenandsushi?ref=${encodeURIComponent(order.orderNumber)}`;
...
{order.orderText}
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-center text-[#705d48]">
              If Messenger did not open automatically, tap the button above.
            </p>
          </div>
