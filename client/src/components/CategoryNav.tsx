        ...
        <div className="flex overflow-x-auto gap-2 py-3 -mx-4 px-4 md:mx-0 md:px-0 md:gap-1">
          {categories.map((category) => (
            <button
              ...
              className={`flex items-center gap-2 px-3 md:px-4 py-2 rounded-lg whitespace-nowrap text-sm md:text-base font-medium transition-all duration-200 flex-shrink-0 ${
                activeCategory === category.id
                  ? "bg-gradient-to-r from-yellow-400 via-orange-500 to-orange-600 text-white shadow-md"
