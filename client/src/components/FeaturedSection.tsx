          ...
          >
            <div className="flex w-max gap-4 md:gap-6 px-2 md:px-4">
              {loopedItems.map((item, index) => (
                <article
                  key={`${item.id}-${index}`}
                  className="group relative min-w-[86vw] max-w-[86vw] sm:min-w-[340px] sm:max-w-[340px] md:min-w-[420px] md:max-w-[420px] bg-white rounded-xl overflow-hidden border border-[#ebe9e6] hover:border-[#c08643]/60 hover:shadow-xl transition-all duration-300"
                >
